...
# Rider-Waite-Smith tarot images — stored locally in static/img/tarot/
TAROT_IMAGES = {key: f"/static/img/tarot/{key}.jpg" for key in [
    "fool","magician","high_priestess","empress","emperor","hierophant",
    "lovers","chariot","strength","hermit","wheel","justice","hanged",
    "death","temperance","devil","tower","star","moon","sun","judgement","world"
]}

MAJOR_ARCANA = [
    {"name": "The Fool", "th": "นักเดินทาง", "key": "fool", "image_url": TAROT_IMAGES["fool"]},
    {"name": "The Magician", "th": "นักมายากล", "key": "magician", "image_url": TAROT_IMAGES["magician"]},
    {"name": "The High Priestess", "th": "นักบวชหญิง", "key": "high_priestess", "image_url": TAROT_IMAGES["high_priestess"]},
    {"name": "The Empress", "th": "จักรพรรดินี", "key": "empress", "image_url": TAROT_IMAGES["empress"]},
    {"name": "The Emperor", "th": "จักรพรรดิ", "key": "emperor", "image_url": TAROT_IMAGES["emperor"]},
    {"name": "The Hierophant", "th": "นักปราชญ์", "key": "hierophant", "image_url": TAROT_IMAGES["hierophant"]},
    {"name": "The Lovers", "th": "คู่รัก", "key": "lovers", "image_url": TAROT_IMAGES["lovers"]},
    {"name": "The Chariot", "th": "ราชรถ", "key": "chariot", "image_url": TAROT_IMAGES["chariot"]},
    {"name": "Strength", "th": "พละกำลัง", "key": "strength", "image_url": TAROT_IMAGES["strength"]},
    {"name": "The Hermit", "th": "ฤาษี", "key": "hermit", "image_url": TAROT_IMAGES["hermit"]},
    {"name": "Wheel of Fortune", "th": "วงล้อโชคชะตา", "key": "wheel", "image_url": TAROT_IMAGES["wheel"]},
    {"name": "Justice", "th": "ความยุติธรรม", "key": "justice", "image_url": TAROT_IMAGES["justice"]},
    {"name": "The Hanged Man", "th": "ผู้ถูกแขวน", "key": "hanged", "image_url": TAROT_IMAGES["hanged"]},
    {"name": "Death", "th": "การเปลี่ยนแปลง", "key": "death", "image_url": TAROT_IMAGES["death"]},
    {"name": "Temperance", "th": "ความพอดี", "key": "temperance", "image_url": TAROT_IMAGES["temperance"]},
    {"name": "The Devil", "th": "ปีศาจ", "key": "devil", "image_url": TAROT_IMAGES["devil"]},
    {"name": "The Tower", "th": "หอคอย", "key": "tower", "image_url": TAROT_IMAGES["tower"]},
    {"name": "The Star", "th": "ดวงดาว", "key": "star", "image_url": TAROT_IMAGES["star"]},
    {"name": "The Moon", "th": "พระจันทร์", "key": "moon", "image_url": TAROT_IMAGES["moon"]},
    {"name": "The Sun", "th": "พระอาทิตย์", "key": "sun", "image_url": TAROT_IMAGES["sun"]},
    {"name": "Judgement", "th": "การพิพากษา", "key": "judgement", "image_url": TAROT_IMAGES["judgement"]},
    {"name": "The World", "th": "โลก", "key": "world", "image_url": TAROT_IMAGES["world"]},
]
